 ...
 */
@interface BFTaskCompletionSource BF_GENERIC(BFResultType) : NSObject
 ...
 */
@property (nonatomic, strong, readonly) BFTask BF_GENERIC(BFResultType) *task;
 ...
 */
- (void)setResult:(BFResultType)result;
 ...
 */
- (BOOL)trySetResult:(BFResultType)result;
