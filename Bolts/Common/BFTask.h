 ...
 */
@interface BFTask BF_GENERIC(BFResultType) : NSObject

/*!
 A block that can act as a continuation for a task.
 */
typedef id(^BFContinuationBlock)(BFTask BF_GENERIC(BFResultType) *task);

/*!
 Creates a task that is already completed with the given result.
 @param result The result for the task.
 */
+ (instancetype)taskWithResult:(BFResultType)result;
 ...
 */
@property (nonatomic, strong, readonly) BFResultType result;
